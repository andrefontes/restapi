...
public class ParticipanteRespostaREST {
    ...
    @RequestMapping("/api/v1/salvar-resposta-por-participante-resposta")
    @PostMapping
    public ResponseEntity<Resposta> salvarRespostaPostParticipanteResposta(@RequestBody Resposta resposta) {
